<?php get_header(); ?>
	<div id="main">
		<p class="topicPath">
			<a href="<?php echo home_url(); ?>"><?php __( 'Home', 'mxs' ); ?></a>&gt; <?php echo 'Tags'; ?> &gt; <span class="current"><?php single_tag_title(); ?></span>
		</p>
		<h1 class="entry-title">Post about "<?php single_cat_title(); ?>"</h1>
